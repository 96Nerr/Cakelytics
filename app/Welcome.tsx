...
const styles = StyleSheet.create({
  ...
  topSection: { flex: 1, backgroundColor: PINK_PRIMARY, borderBottomLeftRadius: 60, borderBottomRightRadius: 60, justifyContent: "center", alignItems: "center", position: "relative" },
  slideItem: { width: width, justifyContent: "center", alignItems: "center" },
  cake: { width: 300, height: 300, resizeMode: "contain" },
  indicatorContainer: { flexDirection: "row", position: "absolute", bottom: 20 },
  dot: { height: 8, borderRadius: 4, marginHorizontal: 4 },
  activeDot: { width: 20, backgroundColor: WHITE },
  inactiveDot: { width: 8, backgroundColor: "rgba(255, 255, 255, 0.4)" },
  bottomSection: { flex: 1, paddingHorizontal: 32, justifyContent: "center", backgroundColor: WHITE },
  title: { fontSize: 26, color: DARK_TEXT, fontWeight: "900", textAlign: "center", marginBottom: 14, letterSpacing: 0.3 },
  description: { color: MUTED_TEXT, textAlign: "center", fontSize: 14, lineHeight: 22, fontWeight: "500", marginBottom: 40, paddingHorizontal: 10, height: 66 },
  button: { backgroundColor: PINK_PRIMARY, paddingVertical: 16, borderRadius: 50, alignItems: "center" },
