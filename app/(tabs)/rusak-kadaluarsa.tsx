...
import { Alert, Image, Modal, Platform, Pressable, ScrollView, StatusBar, StyleSheet, Text, TextInput, TouchableOpacity, View, KeyboardAvoidingView, FlatList } from "react-native";
...
const styles = StyleSheet.create({
  ...
  bsContainer: {borderTopLeftRadius: 28, borderTopRightRadius: 28, paddingTop: 12,paddingHorizontal: 24, paddingBottom: Platform.OS === "android" ? 24 : 36, maxHeight: "80%",
  shadowColor: "#4A1525",shadowOffset: { width: 0, height: -10 }, shadowOpacity: 0.1, shadowRadius: 20,elevation: 15,position: "relative"},
